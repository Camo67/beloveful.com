      ...
      <div className="w-full px-6 md:px-12 lg:px-20 py-12 space-y-16">
        ...
        <section className="max-w-5xl mx-auto space-y-6">
          ...
          <div className="flex justify-center">
            <a
              href="https://open.spotify.com/playlist/7pkDV5vCWUxYvWaA0TL0LT?si=6c2430b9bf1a4325&pt=256043cefa67041c41d37448c8e23104"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full border border-gray-200 dark:border-gray-800 bg-white/70 dark:bg-neutral-950/40 text-black dark:text-white hover:bg-neutral-100 dark:hover:bg-neutral-900 transition-all duration-200 text-sm font-medium"
            >
